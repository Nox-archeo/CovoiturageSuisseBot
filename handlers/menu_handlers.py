...
async def handle_menu_buttons(update: Update, context: CallbackContext):
    ...
    # ❌ SUPPRIMÉ: Cette gestion interfère avec le ConversationHandler
    # Laissons le ConversationHandler gérer search_passengers directement
...
async def handle_help_callbacks(update: Update, context: CallbackContext):
    ...
    if help_type == "driver":
        ...
        text = (
            "📞 *Nous Contacter*\n\n"
            "**Support technique :**\n"
            "• Email: covoituragesuisse@gmail.com\n"
            "• Telegram: @Lilith66store (ID: 5932296330)\n\n"
            "**Questions générales :**\n"
            "• Email: covoituragesuisse@gmail.com\n"
            "• Téléphone: 0795290160\n\n"
            "**Urgences sécurité :**\n"
            "• Numéro d'urgence: 117 (Police)\n"
            "• Email urgent: covoituragesuisse@gmail.com\n\n"
            "**Horaires support :**\n"
